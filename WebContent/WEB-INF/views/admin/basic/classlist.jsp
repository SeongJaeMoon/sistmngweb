...
<div class="container">
		...
		<div class="container-fluid" style="background-color : black;" ><p style="color : white; margin-top:10px">기초정보관리 > 강의실 관리 </p></div>
		</nav>
...
<h4>강의실 관리</h4>
			...
			<button id="btnAdd" type="button" class="btn btn-default pull-right">강의실등록</button>
		</form>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${pageContext.request.contextPath}/admin/BasicManagement/Subject_management.jsp">
							<div class="form-group">
								<label for="addClassName">강의실명 : </label> <input type="text"
									class="form-control" id="addClassName" placeholder="강의실명을 입력하세요"
									name="addClassName">
							</div>
							<div class="form-group">
								<label for="addCount">정원 : </label> <input type="text"
									class="form-control" id="addCount" placeholder="정원을 입력하세요"
									name="addCount">
							</div>
...
<!-- 강의실 삭제  -->
<div class="modal fade" id="classDel" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<form action="test.jsp">
							...
							<!-- readonly는 text만 가능하다. -->
								<label for="delClassCode">강의실코드 : </label> <input type="text"
									class="form-control" id="delClassCode" name="delClassCode" readOnly = "readOnly">
							</div>
						
							<div class="form-group">
								<label for="delClassName">강의실명 : </label> <input type="text"
									class="form-control" id="delClassName" 
									name="delClassName" >
							</div>
							
							<div class="form-group">
								<label for="delCount">정원 : </label> <input type="text"
									class="form-control" id="delCount" 
									name="delCount" >
							</div>
							<div class="modal-footer">
								<button type="submit" class="btn btn-default">확인</button>
