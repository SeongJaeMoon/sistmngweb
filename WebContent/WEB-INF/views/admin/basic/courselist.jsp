	...
	<div class="container">
		...
		<nav class="navbar navbar-inverse">
			...
			<div class="container-fluid" style="background-color: black;">
				<p style="color: white; margin-top: 10px">기초정보관리 > 과정 관리</p>
			</div>
		</nav>
...
<div class="container-fluid full-width">
	<h4>과정 관리</h4>
		...
		<form style="position: relative;">
			...
			<button id="btnAdd" type="button" class="btn btn-default pull-right">과정등록</button>
		</form>
					...
					<div class="modal-body">
						<form action="/action_page.php">
							<div class="form-group">
								<label for="addCourseName">과정명 : </label> <input type="text"
									class="form-control" id="addCourseName" placeholder="과정명을 입력하세요"
									name="addCourseNameS">
							</div>
...
<!-- 과정 삭제  -->
<div class="modal fade" id="courseDel" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<form action="test.jsp">
							...
							<!-- readonly는 text만 가능하다. -->
								<label for="delCourseCode">과정코드 : </label> <input type="text"
									class="form-control" id="delCourseCode" name="delCourseCode" readOnly = "readOnly">
							</div>
						
							<div class="form-group">
								<label for="delCourseName">과정명 : </label> <input type="text"
