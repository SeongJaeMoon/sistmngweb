	...
	$(document).ready(function() {
		...
		$("button.btnRemove").on("click", function() {
			...
			if($('input:checkbox[name="checkbox"]').is(":checked")){
				...
				value += "<thead><th>과목코드</th><th>과목명</th></thead><tbody>";
		...
		$("button.btnAdd").click(function(){
			location.assign("${contextPath}/admin/subjectaddform")
		})
		
		$("button.btnUpdate").click(function(){
			location.assign("${contextPath}/admin/adminsubupdate.jsp")
		});
	});
</script>
	...
	<div class="container">
		...
		<div class="infoboard">
			...
			<table class="table table-bordered text-center">
				...
				<tbody>
					<tr>
						<td><input type="checkbox" name = "checkbox" value ="SUB001"></td>
						<td>1</td>
						<td><a href="${contextPath}/admin/subjectdetaillist">SUB001</a></td>
						<td>JAVA</td>
						...
						<td><button type="button" class="btn btn-default btn-small btnUpdate"
								value="1">수정</button></td>
					</tr>
					<tr>
						<td><input type="checkbox" name = "checkbox" value ="SUB002"></td>
						<td>1</td>
						<td><a href="${contextPath}/admin/subjectdetaillist">SUB002</a></td>
						<td>Python</td>
						<td>2017-01-01~2018-02-01</td>
						<td>점프 투 파이썬.</td>
						<td>이민종</td>
						<!-- 버튼에 id 값 넣어야 함.-->
						<td><button type="button" class="btn btn-default btn-small btnUpdate"
