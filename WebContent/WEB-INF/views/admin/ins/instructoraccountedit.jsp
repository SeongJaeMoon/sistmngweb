	...
	<div class="container">
		...
		<nav class="navbar navbar-inverse">
			...
			<div class="container-fluid" style="background-color: black;">
				<p style="color: white; margin-top: 10px">
					...
					> <a id="navi" 
						href="${contextPath}/admin/insedit">강사 수정</a>
				</p>
			</div>
		</nav>
		<div id="wrapper" style="text-align: center">
			<h3>강사 수정</h3>
			<img src="avatar.png" width="200" height="200" align="top"> <input
				type="file" />
		...
		<div style="float: right;">
			<button type="button" class="btn btn-default" id="add"
				data-toggle="modal" data-target="#myModal2">수정</button>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<form
					...
					<div class="modal-body" style="width: auto; height: auto;">
						...
						<p style="font-size: 15px; margin-top: 55px;">[]을 수정하시겠습니까?</p>
					</div>
					<div class="modal-footer">
